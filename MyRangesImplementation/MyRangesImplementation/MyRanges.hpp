...
namespace ranges {
	...
	namespace view {
		...
		template<typename FirstRange, typename SecondRange, 
			typename Stub = std::enable_if_t<RangeTraits::isRange<FirstRange>() && RangeTraits::isRange<SecondRange>(), void>>
			...
			public:
				...
				zip_range_adapter(const zip_range_adapter<FirstRange, SecondRange, Stub>& other) noexcept
	...
	namespace view {
		...
		template<typename FirstRange, typename SecondRange,
			typename = std::enable_if_t<RangeTraits::isRange<FirstRange>() && RangeTraits::isRange<SecondRange>(), void>>
